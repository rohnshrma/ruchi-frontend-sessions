...
console.log(txt.padEnd(15, "#").padStart(19, "*"));
...
console.log(txt.toLowerCase().replace(/ /g, "-"));
...
var sentence = "Javascript is Old";

console.log(sentence.split(" ").reverse().join(" "));

console.log(txt.match(/[aeiou]/g).length);
